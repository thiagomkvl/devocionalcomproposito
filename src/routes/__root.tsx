...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A fé cresce no silêncio da manhã, antes do mundo fazer barulho. O Presença Diária é um devocional diário entregue no seu WhatsApp às 6h —" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Presença Diária" },
      { property: "og:description", content: "A fé cresce no silêncio da manhã, antes do mundo fazer barulho. O Presença Diária é um devocional diário entregue no seu WhatsApp às 6h —" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Presença Diária" },
      { name: "twitter:description", content: "A fé cresce no silêncio da manhã, antes do mundo fazer barulho. O Presença Diária é um devocional diário entregue no seu WhatsApp às 6h —" },
